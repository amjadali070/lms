  ...
  const [messages, setMessages] = useState<Message[]>([
    {
      role: "assistant",
      content:
        "Hi! 👋 I'm your AI Study Assistant. Ask me anything about this course material and I'll help you understand it better!",
    },
  ]);
    ...
    try {
      ...
      setMessages((prev) => [
        ...prev,
        {
          role: "assistant",
          content:
            "Sorry, I couldn't process that. Please check if the AI service is configured and try again.",
        },
      ]);
    } finally {
      setLoading(false);
