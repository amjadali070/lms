...
const Sidebar: React.FC = () => {
  ...
  return (
    <div
      className={`h-screen bg-primary text-white flex flex-col transition-all duration-300 ${collapsed ? "w-20" : "w-64"}`}
    >
      <div className="flex items-center justify-between p-4 border-b border-primary-light">
        {!collapsed && (
          <img src="/lms-logo.svg" alt="LMS" className="h-9 object-contain" />
        )}
        {collapsed && (
          <img
            src="/favicon.svg"
        ...
        <button
          ...
          className="p-1 rounded hover:bg-secondary text-background"
